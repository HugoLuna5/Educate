                    ...
                    <div class="card">
                        ...
                        <div class="card-body mx-4">
                            ...
                            <div class="md-form pb-3">
                                ...
                                <p class="font-small blue-text d-flex justify-content-end">¿Olvidaste tu
                                    <a href="{{ route('password.request') }}" class="blue-text ml-1"> contraseña?</a>
                                </p>
                            </div>

                            <div class="text-center mb-3">
                                <button type="submit" class="btn aqua-gradient btn-block btn-rounded z-depth-1a waves-effect waves-light">Entrar</button>
                            </div>
                            </form>



                            <p class="font-small dark-grey-text text-right d-flex justify-content-center mb-3 pt-2"> o ingresa con:</p>
                        ...
                        <div class="modal-footer mx-5 pt-3 mb-1">
                            <p class="font-small grey-text d-flex justify-content-end">¿No eres miembro?
                                <a href="{{ route('register') }}" class="blue-text ml-1"> Registrate</a>
                            </p>
                        </div>
