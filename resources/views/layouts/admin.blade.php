...
<header>
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top scrolling-navbar" >
        <div class="container">
            <a class="navbar-brand" href="{{url("/admin")}}"><strong>Educate</strong></a>
...
<script src="{{url("/js/search/instructor.js")}}"></script>
<script src="{{url("/js/search/course.js")}}"></script>
<script src="{{url("/js/addons/datatables.js")}}"></script>
